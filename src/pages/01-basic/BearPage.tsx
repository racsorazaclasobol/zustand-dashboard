...
export const BearsDisplay = () => {
    ...
    return (
        <WhiteCard>
            <h2>Osos</h2>
            <button className="w-full mt-2" onClick={doNothing}>
                doNothing
            </button>
            <button className="w-full mt-2" onClick={addBear}>
                Agregar Oso
            </button>
            <button className="w-full mt-2" onClick={clearBears}>
                Borrar Osos
            </button>
